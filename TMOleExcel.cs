...
namespace TM.Desktop.Interop
{
    ...
    public class ExcelStatic
    {
        ...
        public static void CleanUp(ExcelApp.Application App, ExcelApp.Workbook Book, ExcelApp.Worksheet Sheet, ExcelApp.Range Range)
        {
            ...
            App = null;
            //
            TM.Desktop.ProcessMethod.Kill("EXCEL");
...
namespace TM.Desktop
{
    public class OleExcel
    {
        ...
        public static List<string> GetTableNameList(string DataSource, object[] restrictions)
        {
            try
            {
        ...
        public static List<string> GetTableNameList(string DataSource)
        {
...
public static class TMDBS
{
    ...
    public static System.Data.DataTable TMDBGet(this OleDbConnection con)
    {
        ...
        var dt = TM.Desktop.OleExcel.ToDataTable(con, query);
        Dispose();
        return dt;
    }
    public static bool TMDBDelete(this OleDbConnection con, string table)
    {
        var rs = TM.Desktop.OleExcel.Execute(con, "DELETE * FROM [" + table + "]" + TMDB.where);
        Dispose();
        return rs;
    }
    ...
    {
        var rs = TM.Desktop.OleExcel.Execute(con, "INSERT INTO [" + table + "] VALUES(" + string.Join(",", values) + ")");
        Dispose();
        return rs;
    }
    public static bool TMDBInsert(this OleDbConnection con, string[] values)
    {
        var rs = TM.Desktop.OleExcel.Execute(con, "INSERT INTO [" + TMDB.table + "] VALUES(" + string.Join(",", values) + ")");
        Dispose();
        return rs;
    }
    */
